...
$((function () {
    ...
    if (n.length) var l = n.DataTable({
        ajax: "assets/json/user-list.txt",
        ...
        columnDefs: [{
            ...
            targets: 1, responsivePriority: 4, render: function (e, t, a, n) {
                var s = a.full_name, r = a.email, i = a.avatar;
                if (i) var l = '<img src="' + assetsPath + "img/avatars/" + i + '" alt="Avatar" class="rounded-circle">'; else {
                ...
                return '<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper"><div class="avatar avatar-sm me-3">' + l + '</div></div><div class="d-flex flex-column"><a href="' + o + '" class="text-body text-truncate"><span class="fw-semibold">' + s + '</span></a><small class="text-muted">' + r + "</small></div></div>"
            }
        }, {
